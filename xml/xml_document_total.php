...
foreach($Titulaciones as $Titulacion_actual){
        ...
        if(!empty($itinerarios)){
            foreach ($itinerarios as $valor) {
                if($cuatr!=4 && $cuatr!=5 && $cuatr!=6 && $cuatr!=7 && $cuatr!=8){
                    $Asignaturas_bd=Database::get_asig_xml($id_cal,$valor["id"]);
                }else if (($cuatr==4) ||($cuatr==5)) {
                  $Asignaturas_bd=Database::get_conv_nov_dic_xml($id_cal,$valor["id"]);
                }else{
        ...
        if($cuatr!=4 && $cuatr!=5 && $cuatr!=6 && $cuatr!=7 && $cuatr!=8){
            $Asignaturas_bd=Database::get_asig_xml($id_cal,$Titulacion_actual["id"]);
        }else if (($cuatr==4) ||($cuatr==5)) {
          $Asignaturas_bd=Database::get_conv_nov_dic_xml($id_cal,$Titulacion_actual["id"]);
        }else{
